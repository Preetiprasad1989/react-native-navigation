...
- (instancetype)initWithDict:(NSDictionary *)dict {
	...
	self.animateTabBarButton = [BoolParser parse:dict key:@"animateTabBarButton"];
	self.animationType = [TextParser parse:dict key:@"animationType"];
	self.colorForAnimatingBackground = [ColorParser parse:dict key:@"colorForAnimatingBackground"];
...
- (void)mergeOptions:(RNNBottomTabsOptions *)options {
	...
	if(options.animateTabBarButton.hasValue){
		self.animateTabBarButton = options.animateTabBarButton;
	}
	...
	if(options.colorForAnimatingBackground.hasValue){
		self.colorForAnimatingBackground = options.colorForAnimatingBackground;
	}
